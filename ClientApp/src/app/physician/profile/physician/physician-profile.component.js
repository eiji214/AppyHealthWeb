...
var PhysicianProfileComponent = /** @class */ (function () {
    function PhysicianProfileComponent(physicianService, userService, route, router) {
    ...
    PhysicianProfileComponent.prototype.ngOnDestroy = function () {
        this.unsubscribeAll$.next(true);
        this.unsubscribeAll$.unsubscribe();
    };
    PhysicianProfileComponent.prototype.ngOnInit = function () {
        // tests
    ...
    PhysicianProfileComponent.prototype.toggleEdit = function () {
        if (this.isEditing) {
            this.isEditing = false;
    ...
    PhysicianProfileComponent.prototype.saveChanges = function (doctor) {
        var _this = this;
        console.log(doctor);
    ...
    PhysicianProfileComponent.prototype.switchToPhysician = function () {
        this.viewSwitch = 'physician';
    };
    PhysicianProfileComponent.prototype.switchToPractice = function () {
        var _this = this;
    ...
    PhysicianProfileComponent.prototype.addMarkers = function (locations) {
    ...
    PhysicianProfileComponent.prototype.uploadPhoto = function (provider) {
        var _this = this;
    ...
    PhysicianProfileComponent.prototype.impersonatePractitioner = function (doctor) {
        this.userService.impersonatePractitioner(doctor.Id).subscribe(function (x) {
            console.log(x);
    ...
    ], PhysicianProfileComponent.prototype, "photo", void 0);
    PhysicianProfileComponent = __decorate([
        core_1.Component({
            selector: 'physician-profile',
            templateUrl: './physician-profile.component.html',
            styleUrls: ['./physician-profile.component.css']
        })
    ], PhysicianProfileComponent);
    return PhysicianProfileComponent;
}());
exports.PhysicianProfileComponent = PhysicianProfileComponent;
//# sourceMappingURL=physician-profile.component.js.map