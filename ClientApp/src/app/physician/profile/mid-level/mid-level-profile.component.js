...
var MidLevelProfileComponent = /** @class */ (function () {
    function MidLevelProfileComponent(physicianService, route, router) {
    ...
    MidLevelProfileComponent.prototype.ngOnDestroy = function () {
        this.unsubscribeAll$.next(true);
        this.unsubscribeAll$.unsubscribe();
    };
    MidLevelProfileComponent.prototype.ngOnInit = function () {
        // tests
    ...
    MidLevelProfileComponent.prototype.toggleEdit = function () {
        if (this.isEditing) {
            this.isEditing = false;
    ...
    MidLevelProfileComponent.prototype.saveChanges = function (doctor) {
        var _this = this;
        console.log(doctor);
    ...
    MidLevelProfileComponent.prototype.switchToPhysician = function () {
        this.viewSwitch = 'physician';
    };
    MidLevelProfileComponent.prototype.switchToPractice = function () {
        var _this = this;
    ...
    MidLevelProfileComponent.prototype.addMarkers = function (locations) {
    ...
    MidLevelProfileComponent.prototype.uploadPhoto = function (provider) {
        var _this = this;
    ...
    ], MidLevelProfileComponent.prototype, "photo", void 0);
    MidLevelProfileComponent = __decorate([
        core_1.Component({
            selector: 'mid-level-profile',
            templateUrl: './mid-level-profile.component.html',
            styleUrls: ['./mid-level-profile.component.css']
        })
    ], MidLevelProfileComponent);
    return MidLevelProfileComponent;
}());
exports.MidLevelProfileComponent = MidLevelProfileComponent;
//# sourceMappingURL=mid-level-profile.component.js.map